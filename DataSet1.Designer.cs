...
namespace ItemManager.DataSet1TableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Products] WHERE (([ProductCode] = @Original_ProductCode) AND ([Descr" +
                "iption] = @Original_Description) AND ([UnitPrice] = @Original_UnitPrice) AND ([O" +
                "nHandQuantity] = @Original_OnHandQuantity))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Products] ([ProductCode], [Description], [UnitPrice], [OnHandQuantity]) VALUES (@ProductCode, @Description, @UnitPrice, @OnHandQuantity);
SELECT ProductCode, Description, UnitPrice, OnHandQuantity FROM Products WHERE (ProductCode = @ProductCode) ORDER BY ProductCode";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Products] SET [ProductCode] = @ProductCode, [Description] = @Description, [UnitPrice] = @UnitPrice, [OnHandQuantity] = @OnHandQuantity WHERE (([ProductCode] = @Original_ProductCode) AND ([Description] = @Original_Description) AND ([UnitPrice] = @Original_UnitPrice) AND ([OnHandQuantity] = @Original_OnHandQuantity));
SELECT ProductCode, Description, UnitPrice, OnHandQuantity FROM Products WHERE (ProductCode = @ProductCode) ORDER BY ProductCode";
        ...
        private void InitConnection() {
            ...
            string projbin = System.Environment.CurrentDirectory;
            string actualdir = System.IO.Directory.GetParent(projbin).Parent.Parent.FullName;
            string target = actualdir + "\\MMABooks.mdf;";
            this._connection.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDBFileName=" + target  +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        ProductCode, Description, UnitPrice, OnHandQuantity\r\nFROM          " +
